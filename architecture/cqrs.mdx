...
┌────────────────────┐   ┌─────────────────────────┐  ┌───────────────────────┐
│ lobby               │  │ event_store              │  │ game_projection        │
│ game                │  │ future_event_era_index   │  │ game_player            │
│ action_round        │  │ era_players              │  │ game_active_event      │
│ event_publication   │  │ outbox_events            │  │ player_game_state      │
└────────────────────┘   └─────────────────────────┘  └───────────────────────┘
```
